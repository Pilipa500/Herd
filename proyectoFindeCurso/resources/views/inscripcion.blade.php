            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="\edicion">Busca a tus compis</a>
                        </li>
                    </ul>
        </nav>
    </header>
        ...
        <div class="container">
            <div class="row justify-content-start">
                <div class="col-xl-5 col-md-8">
                    <form class="bg-white rounded shadow-5-strong p-5" method="post" action="{{ route('guardar_inscripcion') }}">
                        ...
                        <fieldset class="form">
                            ...
                            <div class="form-outline mb-4" data-mdb-input-init>
                                ...
                                <input type="text" id="formInscripcion1" value=""
                            ...
                            <div class="form-outline mb-4" data-mdb-input-init>
                                ...
                                <input type="text" id="formInscripcion" value=""
                                    class="form-control" required />
                            ...
                            <div class="form-outline mb-4" data-mdb-input-init>
                                ...
                                <input type="email" id="formInscripcion" value=""
                                    class="form-control" required />
                            ...
                            <div class="form-outline mb-4" data-mdb-input-init>
                                ...
                                <select class="form-label" name=“provincias”>
                            ...
                            <div class="form-outline mb-4" data-mdb-input-init>
                                <label class="form-label" for="formInscripcion1">Elije una fecha en la que terminaste
                                    los estudios en los que buscas a tus compañeros (escribe número exclusivamente. Ejem.
                                    1980): </label>
                                <input type="number" id="formInscripcion" value=""
                                    class="form-control" required />

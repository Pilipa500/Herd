...
{{-- }Aqui puse un controlador de error: "si viene cualquier error: muestra este código"  --}}
    @if ($errors->any())    
        <div class="alert alert-danger mt-2">
                <strong>Vaya por Dios!</strong> Algo fue mal...<br><br>
                <ul>
    ...
    <form action="{{route('tasks.store')}}" method="POST">
      {{-- con este @csrf conseguimos que se agregue el token que da seguridad al formulario  --}}
        @csrf
        <div class="row">
